...
public class MenuBackup {
    ...
    MenuBackup() {
        ...
        // Cria um arraylist com o nome de todos os arquivos, ja que eles sempre serão os mesmos
        this.arquivos = new ArrayList<String>();
        arquivos.addAll(Arrays.asList("blocos.listainv", "categorias", "categorias.hash_c", "categorias.hash_d", "dicionario.listainv", "tarefas_categorias.btree"
         , "tarefas_NomeId.hash_c", "tarefas_NomeId.hash_d", "tarefas", "tarefas.hash_c", "tarefas.hash_d"));
    }
    ...
    public void Backup() {
        ...
        for (int i = 0; i < arquivos.size(); i++) {
            // chama p metodo com parametros para a criação dos arquivos compactados, um por um
